...
--criação de uma tabela para armazenar usuário
...
--utilizando algoritmo MD4 (Seguindo os últimos exemplo de Linhas x Colunas)
SELECT Id, Email, HASHBYTES('MD4', Senha) AS 'Senha Hash' FROM Usuarios WHERE Id = 1;

--utilizando algoritmo MD5 (Seguindo os últimos exemplo de Linhas x Colunas)
SELECT Id, Email, HASHBYTES('MD5', Senha) AS 'Senha Hash' FROM Usuarios WHERE Id = 1;

--utilizando algoritmo SHA (Seguindo os últimos exemplo de Linhas x Colunas)
SELECT Id, Email, HASHBYTES('SHA', Senha) AS 'Senha Hash' FROM Usuarios WHERE Id = 1;

--utilizando algoritmo SHA1 (Seguindo os últimos exemplo de Linhas x Colunas)
SELECT Id, Email, HASHBYTES('SHA1', Senha) AS 'Senha Hash' FROM Usuarios WHERE Id = 1;

--utilizando algoritmo SHA2_256 (Seguindo os últimos exemplo de Linhas x Colunas)
SELECT Id, Email, HASHBYTES('SHA2_256', Senha) AS 'Senha Hash' FROM Usuarios WHERE Id = 1;

--utilizando algoritmo SHA2_512 (Seguindo os últimos exemplo de Linhas x Colunas)
